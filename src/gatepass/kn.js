...
const KN = {
  ...
  /* The whole instruction to the visitor, now that there is nothing to show.
     Short on purpose: it is read once, at a barrier, through a car window. */
  nothing_to_show: 'ತೋರಿಸಲು ಏನೂ ಬೇಡ',
  staff_will_type: 'ಗೇಟ್‌ನಲ್ಲಿ ಸಿಬ್ಬಂದಿ ನಿಮ್ಮ ವಾಹನ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸುತ್ತಾರೆ. ದಯವಿಟ್ಟು ಸಹಕರಿಸಿ — ಅಷ್ಟೇ, ನೀವು ಮುಂದೆ ಹೋಗಬಹುದು.',
  booking_code: 'ಬುಕಿಂಗ್ ಸಂಕೇತ',

  /* The warning that matters most, because it is the one mistake the gate
     cannot fix: the booking is tied to this number plate, so the vehicle that
     arrives must be the vehicle that was booked. */
  bring_this_vehicle: 'ಇದೇ ವಾಹನವನ್ನು ತನ್ನಿ. ಬೇರೆ ವಾಹನಕ್ಕೆ ಪ್ರವೇಶ ಇಲ್ಲ.',
  ...
  qr_cannot_be_copied: 'ಗೇಟ್‌ನಲ್ಲಿ ತೋರಿಸಲು ಏನೂ ಬೇಡ. ಸಿಬ್ಬಂದಿ ನಿಮ್ಮ ವಾಹನ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ ಒಳಗೆ ಬಿಡುತ್ತಾರೆ.',
  ...
  old_qr_invalid: 'ನಿಮ್ಮ ಬುಕಿಂಗ್ ಹೊಸ ದಿನಾಂಕಕ್ಕೆ ಬದಲಾಗಿದೆ. ಗೇಟ್‌ನಲ್ಲಿ ಬೇರೇನೂ ಮಾಡಬೇಕಿಲ್ಲ.',
  ...
  doc_subtitle: 'ಮುದ್ರಿತ ಟಿಕೆಟ್‌ನ ಬದಲಿಗೆ ವಾಹನ ಸಂಖ್ಯೆಯ ಮೂಲಕ ಪ್ರವೇಶ — ಗೇಟ್‌ನಲ್ಲಿ ತೋರಿಸಲು ಏನೂ ಬೇಡ.',
  ...
  note_one_entry: 'ಒಂದು ವಾಹನಕ್ಕೆ ಒಂದು ದಿನಕ್ಕೆ ಒಂದು ಪ್ರವೇಶ ಮಾತ್ರ.',
  note_only_number: 'ಚೆಕ್‌ಪೋಸ್ಟ್‌ನಲ್ಲಿ ವಾಹನ ಸಂಖ್ಯೆ ಮಾತ್ರ ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ. ನೀವು ತರುವ ವಾಹನದ ನೋಂದಣಿ ಸಂಖ್ಯೆಯಿಂದಲೇ ಬುಕ್ ಮಾಡಿರುವುದನ್ನು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.',
  note_no_swap: 'ಕೊನೆಯ ಕ್ಷಣದಲ್ಲಿ ವಾಹನ ಬದಲಾಯಿಸಬೇಡಿ. ಈ ಸಂಖ್ಯೆಯನ್ನೇ ಚೆಕ್‌ಪೋಸ್ಟ್‌ನಲ್ಲಿ ದಾಖಲಿಸಿ ಪರಿಶೀಲಿಸಲಾಗುತ್ತದೆ; ಬೇರೆ ವಾಹನ ತಂದರೆ ಪ್ರವೇಶ ನಿರಾಕರಿಸಲಾಗುವುದು.',
  note_cooperate: 'ಗೇಟ್‌ನಲ್ಲಿ ಸಿಬ್ಬಂದಿ ನಿಮ್ಮ ವಾಹನ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸುತ್ತಾರೆ. ದಯವಿಟ್ಟು ಸಹಕರಿಸಿ.',
